 ...
 */
final class Version20251106224729 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE covoiturage CHANGE statut statut VARCHAR(50) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE covoiturage CHANGE statut statut VARCHAR(50) DEFAULT \'active\' NOT NULL');
